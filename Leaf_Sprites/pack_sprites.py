...
OUTPUT_NAME = "leaf_sheet.png"
FOLDER_NAME = "leaf_frames"  # Where your 13 images live

def pack_sheet():
    # 2. FIND IMAGES in the folder
    ...
    # 3. CREATE BLANK CANVAS black with transparency (RGBA)
